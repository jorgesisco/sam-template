...
# Tag Container
docker tag serviform:latest "$AWS_ACCOUNT_NUMBER".dkr.ecr.eu-central-1.amazonaws.com/lambda-image:"$NEW_VERSION";
...
docker push "$AWS_ACCOUNT_NUMBER".dkr.ecr.eu-central-1.amazonaws.com/lambda-image:"$NEW_VERSION"